...
// Graph variables
var graph, link, node, text,
    linkedByIndex = { },
    nodesOrden = [ 'Equipo', 'Datos', 'Gobierno Abierto', 'Genero',
                   'Comunidad e innovación', 'Tecnología Cívica' ];

// Proyect description html
var proyectDivTitle = document.getElementsByClassName( 'proyectTitle' )[ 0 ],
    proyectDivContent = document.getElementsByClassName( 'proyectContent' )[ 0 ],
    proyectDivImg = document.getElementsByClassName( 'proyectImg' )[ 0 ];
  ...
  d3.graphScroll( )
    ...
    .on( 'active', function ( i ) {
      ...
      if ( i == 0 ) {
        ...
        //location.hash = 'gobierno_abierto'
        moveNodes( 5, 1000 );
        highlightArea( 'Gobierno Abierto' );
      }
      else if ( i == 6 ) {
        //location.hash = 'genero'
        moveNodes( 6, 1000 );
        highlightArea( 'Genero' );
      }
      else if ( i == 7 ) {
        //location.hash = 'comunidad_e_innovación'
        moveNodes( 7, 1000 );
        highlightArea( 'Comunidad e innovación' );
      }
      else if ( i == 8 ) {
        //location.hash = 'tecnología_cívica'
        moveNodes( 8, 1000 );
